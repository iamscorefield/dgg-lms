...
export function StudentStatusActions({ studentId, status }: Props) {
    ...
    <>
      ...
      >
        <input
          type="hidden"
          name="returnTo"
          value="/dashboard/admin/students"
        />
        ...
        {/* hidden input used when confirming disable */}
        {currentStatus === "active" && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-lg max-w-sm w-full mx-4 p-6 relative">
            ...
            <p className="text-xs text-gray-700 mb-4">
              This student will lose access to their dashboard and courses until
              you enable them again from the admin panel.
            </p>
