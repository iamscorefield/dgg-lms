  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 lg:ml-64 p-6 lg:p-10">
        ...
        {/* Assigned Students */}
        <h2 className="text-3xl font-bold text-[#512d7c] mb-8 text-left">
            ...
            {assignedStudents?.map((assignment: any) => (
              ...
              >
                <h3 className="text-2xl font-bold text-[#512d7c] mb-2">
                  {assignment.enrollments?.profiles?.full_name || "DGG Student"}
                </h3>
                <p className="text-gray-700 mb-4">
                  {assignment.enrollments?.courses?.title || "Enrolled Track"}
                </p>
                <p className="text-sm text-gray-600 mb-6">
                  One‑on‑One Sessions
                </p>
                <div className="flex gap-4">
                  <button className="flex-1 py-3 bg-[#512d7c] text-white font-bold rounded-lg hover:bg-[#3f2361] border-0 cursor-pointer">
                    View Progress
                  </button>
                  <button className="flex-1 py-3 bg-[#f2b42c] text-black font-bold rounded-lg hover:bg-[#e0a51a] border-0 cursor-pointer">
                    Schedule Session
                  </button>
                </div>
              </div>
        ...
        {/* Upload Assignments */}
        <h2 className="text-3xl font-bold text-[#512d7c] mt-16 mb-8 text-left">
        ...
        <div className="bg-white p-8 rounded-2xl shadow text-left">
          ...
          <button className="px-8 py-4 bg-[#512d7c] text-white font-bold rounded-full hover:bg-[#3f2361] border-0 cursor-pointer">
            Create Assignment
          </button>
        </div>
